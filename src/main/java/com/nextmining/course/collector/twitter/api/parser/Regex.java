package com.nextmining.course.collector.twitter.api.parser;
...
public class Regex {
	  ...
	  **/
	  ...
	  public static final Pattern EXTRACT_REPLY = Pattern.compile("^(?:[" + com.nextmining.course.collector.twitter.api.parser.Spaces.getCharacterClass() + "])*" + AT_SIGNS + "([a-z0-9_]{1,20}).*", Pattern.CASE_INSENSITIVE);
